...
<template>
    ...
    <div class="h-screen pb-12 sm:pb-0 relative scroll-smooth perspective">
        <nav class="grid place-items-center absolute w-full top-0 z-50 drop-shadow-text-sm"
            aria-label="Primary Navigation">
            <a href="/" aria-label="Go Home"
                class="p-1 m-4 focus:outline-none focus-visible:ring-4 ring-accent rounded-full transition-shadow">
                <img class="w-12 sm:w-16 lg:w-24" src="@img/bps.svg" alt="logo" />
            </a>
        </nav>
        <div class="h-4/5 mb-5 leading-normal tracking-normal text-white gradient">
            <div data-aos="fade-up" class="pt-20 pl-40">
                <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                        ...
                        <Button variant="alternate" v-on:click="scrollToElement()">
                            Mulai
                        </Button>
                    </div>
        ...
        <div data-aos="fade-up" id="statistik" class="container pb-5 stat">
            <Card class="divide-y divide-solid">
                <CardHeader>
                    <CardTitle class="text-center text-2xl text-slate-500">Statistik Layanan 2024</CardTitle>
                </CardHeader>
                <CardContent>
                    <div class="mt-2 grid grid-cols-6 gap-4">
                        <div class="text-center">
                            <h1 class="text-5xl font-bold text-blue-800">0</h1>
            ...
            <form @submit.prevent>
                ...
                <div class="flex flex-wrap justify-center gap-8">
                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-1" value="1" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                        ...
                        <div
                            ...
                            <div>
                                <img src="@img/layanan-1.svg" alt="Layanan 1" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>

                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-2" value="2" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="@img/layanan-2.svg" alt="Layanan 2" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>
                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-3" value="3" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="@img/layanan-3.svg" alt="Layanan 3" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>
                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-4" value="4" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="@img/layanan-4.svg" alt="Layanan 4" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>
                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-5" value="5" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="@img/layanan-5.svg" alt="Layanan 5" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>
                    <label data-aos="fade-up" class="relative cursor-pointer">
                        <input type="checkbox" id="layanan-6" value="6" v-model="form.checkedLayanans"
                            class="peer sr-only" name="size-choice" />
                        <span class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white" width="32"
                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="@img/layanan-6.svg" alt="Layanan 6" class="h-60 w-60 object-cover" />
                            </div>
                        </div>
                    </label>
                </div>
                <div data-aos="fade-up" class="my-5 text-center">
                    <Dialog>
                        <DialogTrigger :disabled="noCheckboxChecked">
                            <Button variant="tertiary" :disabled="noCheckboxChecked"> Isi survei </Button>
                        </DialogTrigger>
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>
                                ...
                                <DialogDescription>
                                    <div class="my-5 divide-y divide-solid">
                                    </div>
                                </DialogDescription>
                                <div class="flex flex-wrap justify-center gap-10">
                                    <label class="relative cursor-pointer">
                                        <input type="radio" id="nilai-baik" value="1" v-model="form.nilai"
                                            class="peer sr-only" name="size-choice" />
                                        <span
                                            class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-5">
                                                <img src="@img/baik.png" alt="Baik"
                                                    class="mx-auto h-50 w-50 object-cover" />
                                            </div>
                                            <header class="px-2.5 py-2.5 text-center">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" id="nilai-cukup" value="2" v-model="form.nilai"
                                            class="peer sr-only" name="size-choice" />
                                        <span
                                            class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white"
                                        ...
                                        <div
                                            class="h-80 w-80 overflow-hidden rounded-lg bg-white ring ring-transparent transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                                            <div class="mt-5">
                                                <img src="@img/cukup.png" alt="Cukup"
                                                    class="mx-auto h-50 w-50 object-cover" />
                                            </div>
                                            <header class="px-2.5 py-2.5 text-center">
                                                <p class="text-2xl font-bold tracking-wide text-gray-700">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" id="nilai-buruk" value="3" v-model="form.nilai"
                                            class="peer sr-only" name="size-choice" />
                                        <span
                                            class="absolute top-2 right-2 z-10 opacity-0 transition-all peer-checked:opacity-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 stroke-white"
                                        ...
                                        <div
                                            class="h-80 w-80 overflow-hidden rounded-lg bg-white ring ring-transparent transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                                            <div class="mt-5">
                                                <img src="@img/buruk.png" alt="Buruk"
                                                    class="mx-auto h-50 w-50 object-cover" />
                                            </div>
                                            <header class="px-2.5 py-2.5 text-center">
                                                <p class="text-2xl font-bold tracking-wide text-gray-700">
                            ...
                            <DialogFooter>
                                <Button class="mt-5 w-1/5" type="submit" @click="submit" variant="tertiary">Kirim
                                    Penilaian</Button>
                            </DialogFooter>
                        </DialogContent>
                    </Dialog>
