...
<template>
    ...
    <div class="h-screen pb-12 sm:pb-0 overflow-y-auto overflow-x-hidden relative scroll-smooth perspective">
        ...
        <div id="statistik" class="container pb-5 stat">
            <Card>
                <CardHeader>
                    <CardTitle class="text-center">Card Title</CardTitle>
        ...
        <main class="h-full relative mt-10 overflow-hidden">
            <div id="layanan" class="mx-auto max-w-4xl">
                <div class="text-center">
                    <h1 class="my-4 text-3xl font-bold leading-tight">Pilih Layanan yang telah diterima</h1>
                </div>
                <div class="flex flex-wrap justify-center gap-20">
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            ...
                            <div>
                                <img src="https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category One</p>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="https://images.unsplash.com/photo-1630650231815-a567e2ed26cc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category Two</p>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="https://images.unsplash.com/photo-1598228723793-52759bba239c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category Three</p>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1073&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category Four</p>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="https://images.unsplash.com/photo-1628624747186-a941c476b7ef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category Five</p>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div
                            class="overflow-hidden rounded-lg bg-white shadow-md ring ring-transparent grayscale transition-all active:scale-95 peer-checked:ring-blue-500 peer-checked:grayscale-0">
                            <div>
                                <img src="https://images.unsplash.com/photo-1518780664697-55e3ad937233?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80"
                                    alt="Sofa 1" class="h-28 w-48 object-cover" />
                            </div>
                            <header class="px-2.5 py-2.5">
                                <p class="text-lg font-bold tracking-wide text-gray-700">Category One</p>
